...
public class AlojamentoController implements Serializable {
    ...
    @EJB
    private br.com.ultradata.comeerj1.beans.AlojamentoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("AlojamentoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("AlojamentoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("AlojamentoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
