...
import ultradata.com.comeerj.beans.util.EquipeFacade;
...
public class EquipeController implements Serializable {
    ...
    @EJB
    private ultradata.com.comeerj.beans.util.EquipeFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/app").getString("EquipeCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/app").getString("EquipeUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/app").getString("EquipeDeleted"));
        if (!JsfUtil.isValidationFailed()) {
